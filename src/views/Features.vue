<template>
  <div class="bg-black text-white min-h-screen font-sans">
    <!-- Hero Section -->
    <section class="pt-40 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <div class="max-w-5xl mx-auto text-center relative z-10">
        <h1 class="text-4xl sm:text-5xl font-medium mb-6">
          Vanguard's Features
        </h1>
        <p class="text-xl mb-8 text-gray-200">
          Powerful backup solutions for developers who value simplicity and
          efficiency.
        </p>
        <a
          href="#features"
    ...
    <!-- Features Sections -->
    <div id="features" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <!-- Security Feature -->
      ...
      <section class="py-24 border-b border-gray-800">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div class="relative w-80 h-80 mx-auto">
            <div
              v-for="(tech, index) in compatibilityTech"
              :key="tech.name"
            ...
            >
              <component
                :is="tech.icon"
                class="w-8 h-8 text-black transition-colors duration-1000"
              />
            </div>
          </div>
          <div>
            <p class="text-gray-400 mb-8 text-lg">
              Vanguard is designed to work seamlessly across various
              environments, with dedicated support for Ubuntu and Debian-based
              systems. Integrate effortlessly with your existing infrastructure
              for comprehensive backup coverage.
            </p>
            <ul class="space-y-4">
              <li
                v-for="point in compatibilityPoints"
                :key="point"
                class="flex items-center"
              >
                <svg
      ...
      <section class="py-24 border-b border-gray-800">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div
            v-for="(feature, index) in dataProtectionFeatures"
            :key="index"
      ...
      <section class="py-24 border-b border-gray-800">
        <div class="flex flex-col lg:flex-row items-center">
          ...
          <div class="lg:w-1/2 lg:pl-12">
            ...
            <p class="text-gray-400 mb-8 text-lg">
              Harness Vanguard's full potential with our robust API and sleek
              PHP SDK.
            </p>
            <ul class="space-y-4">
              <li
                v-for="point in apiSdkPoints"
                :key="point"
                class="flex items-center"
              >
                <svg
      ...
      <section class="py-24 border-b border-gray-800">
        <div class="flex flex-col lg:flex-row items-center">
          <div class="lg:w-1/2 mb-12 lg:mb-0">
            ...
            <p class="text-gray-400 mb-8 text-lg">
              Harness the power of intelligent scheduling and management to
              optimize your backup strategy.
            </p>
            <ul class="space-y-4">
              <li
                v-for="point in automationPoints"
                :key="point"
                class="flex items-center"
              >
                <svg
          ...
          <div class="lg:w-1/2 lg:pl-12">
            ...
            <p class="text-gray-400 mb-8 text-lg">
              Vanguard offers first-class support for Laravel applications,
              ensuring your artisan-crafted projects are always protected.
            </p>
            <ul class="space-y-4">
              <li
                v-for="point in laravelPoints"
                :key="point"
                class="flex items-center"
              >
                <svg
      ...
      <section class="py-24 border-b border-gray-800">
        <h2 class="text-4xl font-medium mb-12 text-center">
          Weekly Backup Insights
        </h2>
        <div class="flex flex-col lg:flex-row items-start">
          <div class="lg:w-1/2 mb-12 lg:mb-0 lg:pr-12">
            <h3 class="text-2xl font-semibold mb-6">
              Comprehensive Weekly Summary Emails
            </h3>
            <p class="text-gray-400 mb-8">
              Stay informed about your backup activities with our detailed
              weekly reports, delivered straight to your inbox.
            </p>
            <ul class="space-y-4">
              <li
                v-for="point in weeklySummaryPoints"
                :key="point"
                class="flex items-center"
              >
          ...
          <div class="lg:w-1/2 bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <div class="space-y-3">
              ...
              <p>
                <span class="font-semibold">Overall Success Rate:</span> 97.6%
              </p>
              <p>
                <span class="font-semibold">Total Data Protected:</span> 1.2 TB
              </p>
              <p>
                <span class="font-semibold">Average Backup Duration:</span> 15
                minutes
              </p>
              <p>
                <span class="font-semibold">Most Active Project:</span>
                e-commerce-platform
              </p>
            </div>
            <p class="mt-4 text-sm text-gray-400">
              Enable weekly summaries in your account settings for these
              detailed insights.
            </p>
          </div>
        </div>
      ...
      <section class="py-24 border-b border-gray-800">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div class="bg-gray-900 p-6 rounded-lg">
            ...
            <p class="text-gray-400 mb-8">
              Store your backups securely with support for various cloud
              providers:
            </p>
            <ul class="space-y-4">
              <li
                v-for="destination in backupDestinations"
                :key="destination.name"
                class="flex items-center bg-gray-950 border border-gray-800/95 rounded-lg p-4"
              >
                <component
                  :is="destination.icon"
                  :class="`w-6 h-6 mr-4 flex-shrink-0 ${destination.color}`"
                />
            ...
            <ul class="space-y-4">
              ...
              >
                <component
                  ...
                  :class="`w-6 h-6 mr-4 flex-shrink-0 ${notification.color}`"
                />
          ...
          <div class="flex flex-col lg:flex-row items-start">
            <div class="lg:w-1/2 mb-12 lg:mb-0 lg:pr-12">
              <p class="text-xl text-gray-300 mb-8">
                Vanguard breaks language barriers, allowing developers worldwide
                to use the platform in their preferred language. Our commitment
                to accessibility ensures a seamless experience for everyone.
              </p>
              <h3 class="text-2xl font-medium mb-6">Multilingual Features</h3>
              <ul class="space-y-6">
                <li
                  v-for="feature in languageFeatures"
                  :key="feature.text"
                  class="flex items-center"
                >
                  <component
                    :is="feature.icon"
                    class="w-8 h-8 mr-4 text-blue-400"
                  />
            ...
            <div class="lg:w-1/2 bg-gray-900 p-8 rounded-lg shadow-xl">
              ...
              <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
                <div
                  ...
                  :key="lang.code"
                  class="flex items-center bg-gray-800 p-3 rounded"
                >
                  <span>{{ lang.name }}</span>
                </div>
              </div>
      ...
      <section class="py-24 border-b border-gray-800">
        <div class="flex flex-col items-center">
          ...
          <h2 class="text-4xl font-medium mb-6 text-center">
            Open Source Power
          </h2>
          <p class="text-xl text-gray-400 mb-8 text-center max-w-3xl">
            Vanguard is proudly open source, harnessing the power of
            community-driven development for enhanced security, transparency,
    ...
    <section class="py-24 px-4 sm:px-6 lg:px-8 bg-white text-black">
      <div class="max-w-4xl mx-auto text-center">
        ...
        <p class="text-xl mb-12 text-gray-600">
          Join the Vanguard community and experience unparalleled data
          protection.
        </p>
        <div
        ...
        >
          <a
            ...
            class="inline-flex items-center justify-center bg-black text-white font-semibold py-4 px-8 rounded-full text-lg transition-all duration-300 hover:bg-gray-800 hover:scale-105 transform"
          >
            Self-Host Vanguard
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            ...
            class="inline-flex items-center justify-center bg-white text-black font-semibold py-4 px-8 rounded-full text-lg transition-all duration-300 border-2 border-black hover:bg-black hover:text-white hover:scale-105 transform"
          >
            Try Hosted Version
            <svg
              xmlns="http://www.w3.org/2000/svg"
...
const compatibilityTech = [
  ...
  { name: 'Debian', icon: DebianIcon, color: '#A81D33' },
...
const dataProtectionFeatures = [
  {
    ...
    description: 'Complete MySQL and PostgreSQL database preservation',
  },
  {
    icon: Server,
    title: 'File Backups',
    description:
      'Intelligent file and directory backup with customizable rules',
  },
  {
    icon: Cloud,
    title: 'Flexible Storage',
    description: 'Support for Amazon S3 and custom S3 providers',
  },
]
...
const backupDestinations = [
  ...
  {
    icon: Cloud,
    name: 'Custom S3-compatible providers',
...
const languageFeatures = ref([
  ...
  { icon: Languages, text: 'Easy language switching within the interface' },
  { icon: GitPullRequest, text: 'Community-driven translations' },
])
