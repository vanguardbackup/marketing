  ...
  <div class="bg-black text-white font-sans">
    ...
    >
      <div class="max-w-6xl mx-auto">
        ...
        <p class="text-xl md:text-2xl text-gray-300 mb-14 max-w-3xl mx-auto">
          Manage your backups on the go with our powerful, secure mobile
          companion app.
        </p>
        <div class="flex flex-col sm:flex-row justify-center gap-6 mb-20">
          <a
            href="#"
            class="bg-white text-black font-semibold py-4 px-10 rounded-full transition-all duration-300 hover:bg-gray-200 hover:scale-105 transform inline-flex items-center justify-center text-lg group"
          >
    ...
    <section class="py-28 bg-gray-900">
      <div class="container mx-auto px-6 text-center">
        ...
        <p class="text-xl mb-16 text-gray-300 max-w-3xl mx-auto">
          Running your own Vanguard instance? Vanguard Mobile supports custom
          endpoint URLs, allowing you to connect to your self-hosted Vanguard
          server seamlessly.
        </p>
        <div
    ...
    <section class="py-28 bg-black">
      <div class="container mx-auto px-6 text-center">
        ...
        <p class="text-xl mb-20 text-gray-300 max-w-3xl mx-auto">
          Your data's safety is our top priority, whether you're using our
          cloud-hosted solution or connecting to your own server.
        </p>
    ...
    <section class="py-28 bg-gradient-to-t from-gray-900 to-black">
      <div class="container mx-auto px-6 text-center">
        ...
        <p class="text-xl mb-16 text-gray-300 max-w-3xl mx-auto">
          Download Vanguard Mobile now and manage your backups from anywhere,
          whether you're using our cloud service or your own self-hosted
          instance!
        </p>
        <div
        ...
        >
          <a
            href="#"
            class="bg-white text-black font-medium py-5 px-12 rounded-full text-xl transition-all duration-300 hover:bg-gray-200 hover:scale-105 transform inline-flex items-center justify-center group"
          >
