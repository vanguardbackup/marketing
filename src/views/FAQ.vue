<template>
  <section id="faq" class="bg-black text-white pt-40 pb-20">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <h1 class="text-4xl sm:text-5xl font-medium mb-6 text-center">
      ...
      faqItems: [
        {
          ...
          answer:
            'Vanguard is an open-source backup solution designed for servers and applications. It provides robust and flexible backup options for developers.',
        },
        {
        ...
        },
        {
          ...
          answer:
            'Vanguard supports various types of backups, including:<br>- MySQL and PostgreSQL database backups<br>- File system backups',
        },
        {
          question: 'Can I schedule automated backups?',
          answer:
            'Yes, Vanguard allows you to set up custom cron schedules for flexible automated backups. This feature enables you to create backup tasks that run at specified intervals, ensuring your data is consistently protected.',
        },
        {
