        ...
        <div class="space-y-12">
          <div>
            ...
            <p class="text-lg mb-4">
              We collect minimal information to improve our service and your experience. This includes:
            </p>
            <ul class="list-disc list-inside text-lg space-y-2 ml-4">
              <li>Anonymous usage data through Umami analytics</li>
              <li>Information you provide when contacting us or contributing to the project</li>
            </ul>
          </div>
          ...
          <div>
            <h2 class="text-2xl font-semibold mb-4">3. Cookies and Analytics</h2>
            <p class="text-lg mb-4">
            ...
            <p class="text-lg">
              The Umami script is loaded from https://cloud.umami.is/script.js and uses the website ID "a51c4b23-0e1c-45e5-8a85-863164fe739b".
            </p>
          </div>
