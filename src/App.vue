    ...
    <header
      ...
      <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-4">
          <a href="/" class="h-auto w-36 transform transition-all duration-300 hover:scale-105">
            <Logo/>
          </a>
          ...
          <a href="#getting-started" @click="navigateToGettingStarted"
    ...
    <footer class="relative z-10 bg-gray-900">
      <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div class="md:col-span-2">
            ...
            <div class="mt-6 flex space-x-6">
              <a href="https://github.com/vanguardbackup" target="_blank" class="text-gray-400 hover:text-white">
            ...
            <ul class="space-y-4">
              <li>
                <a href="/features" @click="(e) => navigateAndScrollTop(e, '/features')"
                   class="text-gray-400 hover:text-white transition-colors text-sm">Features</a>
              </li>
              <li>
                <a href="/about" @click="(e) => navigateAndScrollTop(e, '/about')"
                   class="text-gray-400 hover:text-white transition-colors text-sm">About</a>
              </li>
              <li>
              ...
              <li>
                <a class="text-gray-400 hover:text-white transition-colors text-sm" target="_blank"
                   href="mailto:hello@vanguardbackup.com">Contact</a>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul class="space-y-4">
              ...
              <li><a href="https://docs.vanguardbackup.com" target="_blank"
                     class="text-gray-400 hover:text-white transition-colors text-sm">Documentation</a></li>
              <li><a href="https://github.com/vanguardbackup/vanguard/discussions" target="_blank"
                     class="text-gray-400 hover:text-white transition-colors text-sm">Discussions</a></li>
              <li><a href="https://github.com/vanguardbackup/vanguard/issues/new/choose" target="_blank"
                     class="text-gray-400 hover:text-white transition-colors text-sm">Create an Issue</a></li>
              <li><a href="https://docs.vanguardbackup.com/installation" target="_blank"
                     class="text-gray-400 hover:text-white transition-colors text-sm">Installation Guide</a></li>
            </ul>
          </div>
        </div>
        <div class="mt-12 border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <p class="text-gray-400 text-sm mt-4 md:mt-0 font-normal">Vanguard is an open-source project licensed under AGPL 3.0.</p>
        </div>
      </div>
    </footer>
  </div>
